 ...
 * 重写FragmentTabHost来实现状态保存,解决Fragment重新加载
 */
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    static final class TabInfo {
        ...
        TabInfo(String _tag, Class<?> _arg, Bundle _args) {
            tag = _tag;
            arg = _arg;
            args = _args;
        }
...
//                  ft.detach(mLastTab.fragment);
            ...
            if (newTab != null) {
                if (newTab.fragment == null) {
                    newTab.fragment = Fragment.instantiate(mContext, newTab.arg.getName(), newTab.args);
